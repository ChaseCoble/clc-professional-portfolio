                ...
                (<div className="logged-in-wrapper">
                    ...
                    <div className="logged-in-body">
                        ...
                        <div className="logged-in-button-wrapper">
                            <button className="logged-in-btn" id = "Sign Out" type="button" onClick={logOut}></button>
                            <button className="logged-in-btn" id = "Management" type="button" onClick={navigate('/auth/management')}></button>
                        </div>
                    </div>
                </div>) : 
                    ...
                    <div className="logged-out-form">
                        <form onSubmit={handleSubmit} className="form-wrapper">
                            ...
                            <div className="login-btn-wrapper">
                                <button className="login-btn" id = "login" type="submit"></button>
                            </div>
                        </form>
                    </div>
